...
export class ImageUtility {
    ...
    public static triangleSource = require('../images/triangleSource.png');
    public static trianglePlusCircleToSquare = require('../images/triangle_plus_circle_equal_square.png');
