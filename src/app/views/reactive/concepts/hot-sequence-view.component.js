...
var HotSequenceViewComponent = /** @class */ (function () {
    function HotSequenceViewComponent(triangleFactory, hip2B, circleService, router) {
        var _this = this;
    ...
    HotSequenceViewComponent_1 = HotSequenceViewComponent;
    HotSequenceViewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.list = this.circleService.createStreamItems(HotSequenceViewComponent_1.numItems, RanboShapeOptionsService_1.RanboShapeOptionsService.createStreamOption);
        this.list.element
    ...
    HotSequenceViewComponent.prototype.sourceComplete = function (item) {
        this.sourceOutputSubject.next(item);
    };
    HotSequenceViewComponent.prototype.mapOneComplete = function (steamItem) {
        this.startStreamOne();
    };
    HotSequenceViewComponent.prototype.addSubscriber = function () {
        this.subscribers.push(1);
    };
    HotSequenceViewComponent.prototype.startStreamOne = function () {
        var itemIndex = this.listIndex = ++this.listIndex % HotSequenceViewComponent_1.numItems;
        this.streamSourceInputSubject.next(this.itemsToMoveAlong[itemIndex]);
    };
    HotSequenceViewComponent.numItems = 6;
    HotSequenceViewComponent = HotSequenceViewComponent_1 = __decorate([
        core_1.Component({
            selector: 'hot-sequence-view',
            template: require('./hot-sequence.view.component.htm')
        }),
    ...
    return HotSequenceViewComponent;
    var HotSequenceViewComponent_1;
}());
exports.HotSequenceViewComponent = HotSequenceViewComponent;
//# sourceMappingURL=hot-sequence-view.component.js.map