...
export class HotSequenceViewComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.list = this.circleService.createStreamItems(HotSequenceViewComponent.numItems, RanboShapeOptionsService.createStreamOption)
        this.list.element
            .map(el => [el])
    ...
    startStreamOne(): void {
        let itemIndex = this.listIndex = ++this.listIndex % HotSequenceViewComponent.numItems;
